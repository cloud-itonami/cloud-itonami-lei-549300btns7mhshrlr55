# cloud-itonami-lei-549300btns7mhshrlr55

**独立した第三者による分析/アーカイブであり、Par Pacific Holdings, Inc. と提携・後援関係にありません。**
This is an independent third-party archive/analysis. Not affiliated with,
endorsed by, or sponsored by Par Pacific Holdings, Inc..

## What this is

A per-company reference/archive repository in the `cloud-itonami-lei-*`
family (ADR-2607110300, [com-junkawasaki/root design
rationale](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607110300-cloud-itonami-lei-corporate-tos-catalog.edn)).
It archives Par Pacific Holdings, Inc.'s publicly published Terms of Service / Terms of Use
...
actor — it proposes or executes nothing on Par Pacific Holdings, Inc.'s behalf.
The archive itself (`blueprint.edn`, `NOTICE`, `80-data/public/tos.journal.edn`)
is unchanged by anything below — it stays exactly this read-only reference
archive.

**As of 2026-07-24 this repo ALSO carries a governed actor layered on top of
that archive** (`src/tosmonitor/*`, ToSMonitor-LLM ⊣ ToSArchiveGovernor),
added as part of a 10-repo validation batch extending the pilot on
...
This does NOT change the archive's own read-only nature, and it does NOT
extend to every other `cloud-itonami-lei-*` repository — most repos in this
family remain plain archives exactly as ADR-2607110300 describes. See
`## Governed actor` below.

## Company identity

| Field | Value |
|---|---|
| Legal name | Par Pacific Holdings, Inc. |
| LEI | [549300BTNS7MHSHRLR55](https://search.gleif.org/#/record/549300BTNS7MHSHRLR55) |
| Jurisdiction | US-DE |
...
ToS text: copyright Par Pacific Holdings, Inc. (see NOTICE).
