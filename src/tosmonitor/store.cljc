(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Par Pacific Holdings, Inc., LEI
  549300BTNS7MHSHRLR55) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms of Use\nBy accessing this website you agree to these Terms of Use. The content of this site is provided by Par Pacific Holdings, Inc., a petroleum refining, logistics and retail company, for informational purposes only and is subject to change without notice. These Terms are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.parpacific.com/terms-use"
