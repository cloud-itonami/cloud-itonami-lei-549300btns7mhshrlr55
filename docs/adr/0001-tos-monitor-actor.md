...
Par Pacific Holdings, Inc., per ADR-2607110300 -- a read-only reference
...
- **Company**: Par Pacific Holdings, Inc., LEI 549300BTNS7MHSHRLR55,
  website `https://www.parpacific.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.parpacific.com/terms-use`,
  retrieved-at `2026-07-10T05:27:00Z`, doc-type `:terms-of-service`.
